...
const AddExpense = ({onExpenseAdded, preferences, setExpenseModalOpen, setRevenueModalOpen}) => {
  ...
  return (
    ...
    <div style={{display:'flex',flexDirection:'column'}}>
      ...
      <button className='add' onClick={() => setExpenseModalOpen(true)} > <i className="fa-solid fa-arrow-up"></i> Add Expense</button>
      <button className='add' onClick={() => setRevenueModalOpen(true)} > <i className="fa-solid fa-arrow-down"></i> Add Revenue</button>
      </div>
